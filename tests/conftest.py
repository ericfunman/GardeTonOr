...
from src.database.models import Base, Contract
...
def mock_openai_response_market():
    ...
    return {
        "analysis": {
            "tarif_actuel": 19.99,
            "estimation_marche": {"tarif_min": 9.99, "tarif_moyen": 15.99, "tarif_max": 29.99},
...
def mock_openai_response_competitor():
    ...
    return {
        "analysis": {
            ...
            "score_global": {"contrat_actuel": 7.5, "offre_concurrente": 8.0},
        },
        "prompt": "test prompt",
        "raw_response": '{"recommandation": "changer"}',
    }
