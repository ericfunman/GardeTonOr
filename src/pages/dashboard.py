    ...
    with get_db() as db:
        ...
        with col2:
            st.metric(
                ...
                delta=f"{len(contracts_needing_attention)} à vérifier" if contracts_needing_attention else None
            )
        ...
        if contracts_needing_attention:
            ...
            for contract in contracts_needing_attention:
                ...
                with col2:
                    st.markdown(f"📅 Date anniversaire: **{contract.anniversary_date.strftime('%d/%m/%Y')}**")
                ...
                for comp in all_comparisons:
                    if comp.comparison_result and "economie_potentielle_annuelle" in comp.comparison_result:
                        comparison_data.append({
                            ...
                            "Économie potentielle (€/an)": comp.comparison_result.get("economie_potentielle_annuelle", 0)
                        })
