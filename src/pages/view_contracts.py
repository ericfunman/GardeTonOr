...
def _get_energy_data(data, type_energy):
    ...
    return energy_data, is_legacy





def _display_energy_info(col, energy_data, data, type_energy, is_legacy):
...
def _display_energy_pricing(col, energy_data, data, is_legacy):
...
def display_energy(data, type_energy):
    ...
    energy_data, is_legacy = _get_energy_data(data, type_energy)



    col1, col2 = st.columns(2)

    _display_energy_info(col1, energy_data, data, type_energy, is_legacy)

    _display_energy_pricing(col2, energy_data, data, is_legacy)
